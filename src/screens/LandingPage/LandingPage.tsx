          ...
          <section className="ai">
            <div className="ai__wrap">
              ...
              <div className="ai__text">
                <p>L'intelligenza artificiale di Stratikey è progettata e istruita specificamente per il settore industriale.</p>
                
                <p>Comprende dinamiche, tempi e complessità delle vendite B2B, supportando il commerciale con:</p>
                
                <ul className="ai__features">
                  <li>• Suggerimenti mirati</li>
                  <li>• Automazioni intelligenti</li>
                  <li>• Analisi capaci di trasformare i dati in opportunità reali</li>
                </ul>
              </div>
